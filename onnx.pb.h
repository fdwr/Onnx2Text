...
class TrainingInfoProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:onnx.TrainingInfoProto) */ {
 ...
 private:
  ...
  friend struct ::protobuf_onnx_2eproto::TableStruct;
  friend void ::protobuf_onnx_2eproto::InitDefaultsTrainingInfoProtoImpl();
};
// -------------------------------------------------------------------
...
class TensorAnnotation : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:onnx.TensorAnnotation) */ {
 ...
 private:
  ...
  friend struct ::protobuf_onnx_2eproto::TableStruct;
  friend void ::protobuf_onnx_2eproto::InitDefaultsTensorAnnotationImpl();
};
// -------------------------------------------------------------------
...
class SparseTensorProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:onnx.SparseTensorProto) */ {
 ...
 private:
  ...
  friend struct ::protobuf_onnx_2eproto::TableStruct;
  friend void ::protobuf_onnx_2eproto::InitDefaultsSparseTensorProtoImpl();
};
// -------------------------------------------------------------------
...
class TypeProto_Optional : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:onnx.TypeProto.Optional) */ {
 public:
  ...
  inline TypeProto_Optional* New() const PROTOBUF_FINAL { return New(NULL); }

  TypeProto_Optional* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  int GetCachedSize() const PROTOBUF_FINAL { return _cached_size_; }
  private:
  void SharedCtor();
  void SharedDtor();
...
class TypeProto_SparseTensor : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:onnx.TypeProto.SparseTensor) */ {
 public:
  ...
  inline TypeProto_SparseTensor* New() const PROTOBUF_FINAL { return New(NULL); }

  TypeProto_SparseTensor* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  int GetCachedSize() const PROTOBUF_FINAL { return _cached_size_; }
  private:
  void SharedCtor();
  void SharedDtor();
 ...
 private:
  ...
  ::google::protobuf::int32 elem_type_;
  friend struct ::protobuf_onnx_2eproto::TableStruct;
  friend void ::protobuf_onnx_2eproto::InitDefaultsTypeProto_SparseTensorImpl();
};
// -------------------------------------------------------------------
...
class FunctionProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:onnx.FunctionProto) */ {
 ...
 private:
  ...
  ::google::protobuf::internal::ArenaStringPtr domain_;
  friend struct ::protobuf_onnx_2eproto::TableStruct;
  friend void ::protobuf_onnx_2eproto::InitDefaultsFunctionProtoImpl();
};
// ===================================================================
